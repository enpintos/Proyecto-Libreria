...
public class TestCompraVip {
	...
	public static void main(String[] args) {
		...
		car1.quitarLista(compra2);

		System.out.println("Stock antes de la venta: "+libro1.getCantidad());
		System.out.println("Stock antes de la venta: "+libro3.getCantidad());
		...
		System.out.println("Stock postventa: "+libro3.getCantidad());
		} 
